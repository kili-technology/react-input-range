...
var InputRange = (_class = function (_React$Component) {
  ...
  _createClass(InputRange, [{
    ...
    */
    ...
    key: 'updatePositionKili',
    value: function updatePositionKili(stepValue) {
      var values = valueTransformer.getValueFromProps(this.props, this.isMultiValue());
      var roundMin = Math.round(values.min);
      console.log('roundMin', roundMin);
      var roundMax = Math.round(values.max);
      console.log('roundMax', roundMax);
      var middle = Math.round((roundMin + roundMax) / 2);
      console.log('middle', middle);
      var newMin = stepValue - (middle - roundMin);
      console.log('newMin', newMin);
      var newMax = stepValue + (roundMax - middle);
      console.log('newMax', newMax);
      const width = Math.max(0, roundMax - roundMin);
      console.log('width', width);
      console.log('this.props.maxValue', this.props.maxValue);
      console.log('this.props.minValue', this.props.minValue);
      const newValues = {
        min: Math.min(newMin, this.props.maxValue - width),
        max: Math.max(newMax, this.props.minValue + width),
      };
      console.log('newValues', newValues);
      var positions = valueTransformer.getPositionsFromValues(newValues, this.props.minValue, this.props.maxValue, this.getTrackClientRect());
